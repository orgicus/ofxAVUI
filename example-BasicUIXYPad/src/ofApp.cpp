...
void ofApp::setup(){
    ...
    zone.setup("Basic UI Example Zone", 50, 100, 200, ofColor(100,100,100, 150), ofColor(0,255,255, 255), "synth.wav", bufferSize);
    //ZONE UI
    zone.addUI(new ofxAVUIButton("Sample Trigger", ofxAVUIZone::TRIGGER_PLAY), 100);
    zone.addUI(new ofxAVUIToggle("Looping", ofxAVUIZone::TOGGLE_LOOPING), 100);
    //
    zone.addUI(new ofxAVUIXYPad("Pad", ofxAVUIZone::TRIGGER_PLAY, ofxAVUIZone::TRIGGER_PLAY, ofxAVUIZone::PITCH, ofxAVUIZone::VOLUME), 100);
    //START SOUND
